      ...
      <div className="container">
        <div className="row align-items-center">
          ...
          <div className="col-md-6 text-center text-md-start px-5">
            ...
            <h1 className="display-5 fw-bold fst-italic">FoodMart...</h1>
            ...
            {showMore && (
              <div className="mt-3 mb-3">
                <p>
                  At FoodMart..., we are committed to bringing you the freshest ingredients sourced directly from trusted farms. Our range includes organic vegetables, premium dairy products, and specially curated cakes that bring joy to every occasion. Whether you are looking for daily essentials or gourmet treats, we ensure quality and affordability in every purchase.
                </p>
                <p>
